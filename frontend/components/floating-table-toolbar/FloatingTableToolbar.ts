 ...
 */
export class FloatingTableToolbar {
    ...
    constructor(view: EditorView) {
        ...
        const dropdowns = createDropdownConfigs();
        const deleteButton = createDeleteButtonConfig();
    ...
    public show(): void {
        if (!this.isVisible) {
            this.isVisible = true;
            this.renderer.getDom().classList.add("table-toolbar--visible");
        }
    }
    ...
    public hide(): void {
        if (this.isVisible) {
            this.isVisible = false;
            this.renderer.getDom().classList.remove("table-toolbar--visible");
        }
    }
